...
class DealByCategory extends StatefulWidget {
  final String? title;
  ...
  @override
  State<DealByCategory> createState() => _DealByCategoryState();
}

class _DealByCategoryState extends State<DealByCategory> {
  @override
          ...
          children: [
            ...
            SizedBox(
              ...
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.only(top: 16, left: 8, right: 27),
                    child: Row(
