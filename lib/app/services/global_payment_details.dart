...
class PaymentDetails extends GetView<DealsController> {
        ...
        child: Column(
          ...
          children: [
            const Padding(
              ...
              child: TextWidget(
                  text: 'Add your payments Details',
                  textStyle: TextStyle(
                    fontSize: 18,
